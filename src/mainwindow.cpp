...
MainWindow::MainWindow(QWidget* parent) :
    ...
    m_units(PlotValue::Imperial), mWindowMode(Actual), mScoringView(0), mScoringMode(PPC),
    m_mass(70), m_planformArea(2), m_minDrag(0.05), m_minLift(0.0), m_maxLift(0.5), m_maxLD(3.0),
    m_simulationTime(120), mLineThickness(0), mWindE(0), mWindN(0), mWindAdjustment(false),
    mGroundReference(Automatic), mFixedReference(0), mUseDatabase(true), mMapMode(Default) {
    m_ui->setupUi(this);
