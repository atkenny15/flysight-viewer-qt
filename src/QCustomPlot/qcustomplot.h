    ...
    */
    enum GradientPreset {
        gpGrayscale ///< Continuous lightness from black to white (suited for non-biased data
                    ///< representation)
        ,
        gpHot ///< Continuous lightness from black over fiery colors to white (suited for non-biased
              ///< data representation)
        ,
        gpCold ///< Continuous lightness from black over icey colors to white (suited for non-biased
               ///< data representation)
        ,
        gpNight ///< Continuous lightness from black over weak bluish colors to white (suited for
