...
public:
    ...
    void upload(const QString type, const double windowTop, const double windowBottom,
...
private slots:
    ...
    bool getUserDetails(QString* name, QString* countrycode, bool getEquipment, QString* equipment,
                        QString* place);
};
#endif // PPCUPLOAD_H
